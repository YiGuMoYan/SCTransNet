...
parser.add_argument("--pth_dirs", default=['SIRST3/SCTransNet_537_best.pth.tar'], type=list)
...
parser.add_argument("--dataset_names", default=['SIRST3', 'NUDT-SIRST', 'IRSTD-1K'], type=list,
                    help="dataset_name: 'NUAA-SIRST', 'NUDT-SIRST', 'IRSTD-1K', 'SIRST3', 'NUDT-SIRST-Sea'")
    ...
    if opt.pth_dirs == None:
        for i in range(len(opt.model_names)):
            ...
            for dataset_name in opt.dataset_names:
                ...
                print(f"opt.path_dir: {opt.pth_dir}")
                test()
            print('\n')
            opt.f.write('\n')
        opt.f.close()
