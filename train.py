...
# parser.add_argument("--model_names", default=['ISNet'], type=list, help="'ACM', 'ALCNet', 'DNANet', 'ISNet', 'UIUNet', 'RDIAN', 'RISTDnet'")
...
parser.add_argument("--log_dir", type=str, default="./otherlogs/SCTransNet-NUDT-SIRST", help='path of log files')
